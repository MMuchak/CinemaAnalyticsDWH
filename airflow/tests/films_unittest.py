...
from ..dags.films_oltp_to_dwh_dag import evaluate_films_quality_checks

class TestFilmsEtlDag(unittest.TestCase):
    ...
    def test_dag_loaded(self):
        ...
        dag = self.dagbag.get_dag(dag_id='etl_films_oltp_to_dwh')
    ...
    def test_task_order(self):
        ...
        self.assertListEqual(task_ids, ['extract_films', 'data_quality_check'])
    ...
    def test_data_quality_checks_pass(self, mock_hook):
        ...
        evaluate_films_quality_checks(ti=Mock())
    ...
    @patch("dags.films_oltp_to_dwh_dag.send_email")
    @patch("airflow.hooks.postgres_hook.PostgresHook")
